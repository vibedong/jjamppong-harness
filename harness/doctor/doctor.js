...
function nextActionFor(failure) {
  const table = {
    ...
    task_gate_unknown: 'Correct task.yaml current_gate to a known workflow gate before continuing.',
    gate_required_artifact_missing: 'Create the required current-gate artifact before moving forward.',
    gate_artifact_content_insufficient: 'Replace starter text with real gate decisions, evidence, or checklist steps.',
    ...
    hot_context_large_warning: 'Prefer compacting current planning context before continuing.',
    ...
    compound_review_required_for_solution_write: 'Revert the long-term solution write or add compound-review.md with promote decision, target document, and user approval basis.',
  };
